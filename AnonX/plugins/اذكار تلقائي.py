...
message_text = ["االلَّهُمَّ أَعِنِّي عَلَى ذِكْرِكَ , وَشُكْرِكَ , وَحُسْنِ عِبَادَتِكَ🎈💞 ",
...
async def azkarlock(client:Client, message:Message):
    dev = (OWNER_ID)
    global enable_code
    enable_code = True
...
async def azkaropen(client, message):
    global enable_code
    enable_code = False
    dev = (OWNER_ID)
